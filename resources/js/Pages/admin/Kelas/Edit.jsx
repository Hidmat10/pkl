...
export default function Edit({ auth, kelas, guruOptions }) {
    ...
    return (
        <AdminLayout user={auth.user} header="Edit Kelas">
            <Head title="Edit Kelas" />
            
            <div className="max-w-4xl mx-auto">
                <form onSubmit={handleSubmit} className="bg-white shadow-sm sm:rounded-lg">
                    <div className="p-6 border-b border-gray-200">
                        <h2 className="text-xl font-bold text-gray-800">Formulir Edit Data Kelas</h2>
                        <p className="text-sm text-gray-500 mt-1">Perbarui detail kelas di bawah ini.</p>
                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-gray-500">Daftar ini berisi guru yang belum menjadi wali kelas dan wali kelas saat ini.</p>
